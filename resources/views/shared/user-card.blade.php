 ...
 <div class="grid grid-cols-1 md:grid-cols-1 ">
    <div class="p-4 border border-yellow-400 rounded-lg">
        <form class="flex flex-col gap-5 text-white " action="{{route('users.update',$user->id)}}" method="post" enctype="multipart/form-data">
            ...
            <button class="bg-yellow-400 hover:bg-yellow-500 text-black font-semibold py-2 px-4 rounded transition w-1/3 mx-auto">
                Upload
            </button>
        </form>
    </div>
...
@else
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div class="p-4 border border-yellow-400 rounded-lg">
        ...
        <div class="bg-gray-800 p-3 rounded-lg shadow">
            <p><span class="font-semibold text-gray-400">Gaming Name:</span> Bo Bo</p>
        </div>
        <div class="bg-gray-800 p-3 rounded-lg shadow mt-2">
            <p><span class="font-semibold text-gray-400">In-Game Role:</span> Mid</p>
        </div>
        <div class="bg-gray-800 p-3 rounded-lg shadow mt-2">
